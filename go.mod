...
require (
	...
	github.com/sighupio/fury-distribution v1.35.0
...
// Pinned to kubernetes-1.35.x, thanks to https://github.com/kubernetes/kubernetes/issues/79384#issuecomment-521493597
